...
public class AdValidator {
    ...
    /** 
     * A method that checks if the inputted string only contains whole numbers,
     * returns true if it does, returns false if it does not.
     * @param field
     * @return boolean
     */
    ...
    /** 
     * A method that checks if a field is blank, returns true if it is not blank,
     * will throw an exception if it is blank
     * @param field
     * @return boolean
     */
    ...
    /** 
     * A method that checks if the input only contains numbers.
     * Will also put a maximum number of bedroos to 10.
     * If the input is illegal, it will throw an exception.
     * If the input is legal it return true
     * @param bedrooms
     * @return boolean
     */
    ...
    /** 
     * A method that checks if all the fields in the Electronics input is legal, throws an exception if it is not
     * @param title
     * @param description
     * @param price
     * @param brand
    ...
    /** 
     * A method that checks if all the fields in the Clothing input is legal, throws an exception if it is not
     * @param title
     * @param description
     * @param price
     * @param brand
    ...
    /** 
     * A method that checks if all the fields in the Property input is legal, throws an exception if it is not
     * @param title
     * @param description
     * @param price
     * @param propertyType
    ...
    /** 
     * A method that checks if all the fields in the Vehicles input is legal, throws an exception if it is not
     * @param title
     * @param description
     * @param price
     * @param brand
    ...
    /** 
     * A method that checks if all the fields in the Books input is legal, throws an exception if it is not
     * @param title
     * @param description
     * @param price
     * @param author

...
public class RegistrationValidatorTest {
    ...
    @Test
    public void TestUsernameValidation() { // a username should not be longer than 10 characters, nor contain any
                                           // special symbols.
    ...
    @Test
    public void TestPasswordValidation() { // a password needs to be at least 8 characters long, has to contain at least
                                           // one capital letter and one number
        assertThrows(IllegalArgumentException.class, () -> {
            regValidator1.isPasswordValid(""); // testing an empty field
        });
        assertThrows(IllegalArgumentException.class, () -> {
            regValidator1.isPasswordValid("Hello1"); // testing a password with number, capital letter but not enough
                                                     // characters
        });
        // assertThrows(IllegalArgumentException.class, () -> {
    ...
    public void TestcheckExistingUsername() { // this method checks if a username is in a given list. Because our
        ...
        User user2 = new User("username2", "password2", "fullname2", new ArrayList<>(), new ArrayList<>());
        User user3 = new User("username3", "password3", "fullname3", new ArrayList<>(), new ArrayList<>());
  ...
  @Test
  public void TestEqualPasswords() { // methods returns true if the to given passwords match, and throws exception if
                                    // not
    assertThrows(IllegalArgumentException.class, () -> {
    ...
    public void TestIsRegistrationLegal() {
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            regValidator1.isRegistrationLegal("", "Passord11", "Passord11", "Username", testlist); // test for empty
                                                                                                   // field
        });
        assertThrows(IllegalArgumentException.class, () -> {
            regValidator1.isRegistrationLegal("username", "", "Passord11", "Username", testlist); // test for empty
                                                                                                  // field
        });
        assertThrows(IllegalArgumentException.class, () -> {
            regValidator1.isRegistrationLegal("username", "Passord11", "", "Username", testlist); // test for empty
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            regValidator1.isRegistrationLegal("username", "Passord11", "Passord11", "", testlist); // test for empty
                                                                                                   // field
        });
    }

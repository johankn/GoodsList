...
public class AppController {
    ...
    private void makeAd1(){
        try {
            ...
            ad = new Ad(titleField1.getText(), product1, this.user, date, descriptionArea1.getText(), categoryId);
    ...
    private void makeAd2(){
        if (colourChoiceClothing.getValue() != null) {
            ...
            ad = new Ad(titleField2.getText(), product2, this.user, date, descriptionArea2.getText(), categoryId);
    ...
    private void makeAd3(){
        try {
            ...
            ad = new Ad(titleField3.getText(), product3, this.user, date, descriptionArea3.getText(), categoryId);
    ...
    private void makeAd4(){
        if (colourChoiceVehicles.getValue() != null) {
            ...
            ad = new Ad(titleField4.getText(), product4, this.user, date, descriptionArea4.getText(), categoryId);
    ...
    private void makeAd5(){
        try {
            ...
            ad = new Ad(titleField5.getText(), product5, this.user, date, descriptionArea5.getText(), categoryId);

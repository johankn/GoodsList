...
/** 
 * A class that tests that the server loads the correct information with MockMvc.
 */
@AutoConfigureMockMvc
@TestInstance(Lifecycle.PER_CLASS)
@ContextConfiguration(
    classes = {GoodsListController.class, GoodsListService.class, GoodsListApplication.class})
...
public class GoodsListApplicationTest {
  ...
  @MockBean private GoodsListService service;

  private ObjectMapper objectMapper;

  private User user1 =
      new User("bruker1", "Password123", "Kjell", new ArrayList<>(), new ArrayList<>());

  private Vehicles product1 = new Vehicles(30000, "Used", "Volvo", "sedan", 2000, "Brown");
  private Ad ad1 =
      new Ad("Volvo family car", product1, "2022-11-16", "Well used family car", "1", false);
  ...
  /**
   * BeforeAll tests are ran we add user1, ad1 and ad2 to file. The filename for testfile is set in
   * the RestController and service. User1 and ad1 is private fields outside this method so they can
   * be edited when checking updateUser and updateAd.
   */
  @BeforeAll
  public void setup() throws Exception {
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.put(getUrl("setFilename"))
    ...
    final Ad ad2 =
        new Ad("Mercedes sports car", product2, "2022-11-16", "New sportscar", "2", true);
  ...
  public void testGetAllUsers() throws Exception {
    mockMvc
        .perform(MockMvcRequestBuilders.get(getUrl("users")).accept(MediaType.APPLICATION_JSON))
        .andExpect(MockMvcResultMatchers.status().isOk())
        .andReturn();
  ...
  public void testGetAllActiveAds() throws Exception {
    mockMvc
        .perform(MockMvcRequestBuilders.get(getUrl("ads")).accept(MediaType.APPLICATION_JSON))
        .andExpect(MockMvcResultMatchers.status().isOk())
        .andReturn();
  ...
  public void testGetAllAds() throws Exception {
    mockMvc
        .perform(MockMvcRequestBuilders.get(getUrl("allAds")).accept(MediaType.APPLICATION_JSON))
        .andExpect(MockMvcResultMatchers.status().isOk())
        .andReturn();
    ...
    String actualString =
        mockMvc
            .perform(
                MockMvcRequestBuilders.get(getUrl("allAds")).accept(MediaType.APPLICATION_JSON))
            .andExpect(MockMvcResultMatchers.status().isOk())
            .andReturn()
            .getResponse()
            .getContentAsString();
  ...
  public void testUpdateUser() throws Exception {
    ...
    final Ad ad4 = new Ad("Samsung tv", product4, "2022-11-16", "Nice TV", "4", false);
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.put(getUrl("updateUser"))
                .contentType(MediaType.APPLICATION_JSON)
                .characterEncoding("UTF-8")
                .content(json)
                .accept(MediaType.APPLICATION_JSON))
  ...
  public void testNewUser() throws Exception {
    ...
    final User user3 =
        new User("bruker3", "Password123", "Harald", new ArrayList<>(), new ArrayList<>());

    String json = objectMapper.writeValueAsString(user3);

    mockMvc
        .perform(
            MockMvcRequestBuilders.put(getUrl("newuser"))
                .contentType(MediaType.APPLICATION_JSON)
                .characterEncoding("UTF-8")
                .content(json)
                .accept(MediaType.APPLICATION_JSON))
  ...
  public void testUpdateAd() throws Exception {
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.put(getUrl("updateAd"))
                .contentType(MediaType.APPLICATION_JSON)
                .characterEncoding("UTF-8")
                .content(json)
                .accept(MediaType.APPLICATION_JSON))
  ...
  public void testNewAd() throws Exception {
    ...
    final Ad ad3 = new Ad("New airpods!", product3, "2022-11-16", "Works fine", "3", false);
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.put(getUrl("newAd"))
                .contentType(MediaType.APPLICATION_JSON)
                .characterEncoding("UTF-8")
                .content(json)
                .accept(MediaType.APPLICATION_JSON))
